...
export default function LoginPage() {
  ...
  return (
    <div className="font-google-sans w-screen h-screen relative overflow-hidden drop-shadow-[0_0px_20px_rgba(0,0,0,0.3)] flex items-center justify-center bg-[linear-gradient(45deg,theme(colors.cs-orange)_0%,theme(colors.cs-coral)_30%,theme(colors.cs-magenta)_65%,theme(colors.cs-purple)_100%)]">
      <motion.div
